      ...
      <div className="xl:pt-10">
        <div className="pb-5 pt-5 flex w-full pl-5 pr-5 sm:pl-10 sm:pr-10 mb-5 flex-col xl:flex-row">
          <div className="flex flex-col text-[#AAAAB1] items-center xl:items-start xl:w-3/12 ">
            ...
            >
              <div className="flex mt-10 xl:mt-1 cursor-pointer">
                <div className="mb-3 w-12/12 flex flex-col items-center xl:items-start cursor-pointer text-sm sm:text-lg xl:text-sm">
            ...
            <div className="mt-3 lg:mt-5 mb-2 text-sm sm:text-lg xl:text-sm text-start ">
          ...
          <div className="xl:w-2/12 pt-5 xl:pt-0">
            <div>
              <header className="text-lg sm:text-2xl xl:text-lg">
                <h2>Na skróty</h2>
              </header>
            </div>
            <ul className="text-sm text-[#AAAAB1]">
              <li className="mt-2">
                <Link className="mb-2 hover:text-white focus:text-white  cursor-pointer transition ease-in-out duration-300 text-sm sm:text-lg xl:text-sm">
                  O firmie
                </Link>
              </li>
              <li className="mt-2">
          ...
          <div className="xl:w-2/12 flex flex-col xl:items-start items-center pt-5 xl:pt-0">
            ...
            <ul className="mt-3 text-[#AAAAB1]">
              <li className="flex items-center">
                ...
                <div className="hover:text-white focus:text-white  cursor-pointer transition ease-in-out duration-300 text-md  md:text-lg xl:text-md">
                  881 386 881
                </div>
              </li>
              <li className="flex items-center">
                ...
                <div className="hover:text-white focus:text-white  cursor-pointer transition ease-in-out duration-300 text-md">
                  881 386 881
                </div>
              </li>
              <li className="flex items-center">
          ...
          <div className="xl:w-3/12 flex flex-col items-end pt-10 xl:pt-0">
            <div className="flex w-full justify-center items-center flex-col xl:flex-row">
              ...
              <div className=" flex justify-center allegro-icon h-full mt-4">
                <Link>
                  <svg
                    className="w-[130px] h-[45px] sm:w-[200px] sm:h-[90px] xl:w-[130px] xl:h-[45px] allegro-icon"
                    viewBox="0 0 145 50"
                    fill="#ff5a00"
                    xmlns="http://www.w3.org/2000/svg"
                  >
